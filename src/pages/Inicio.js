...
export default class Inicio extends Component {
    ...
    componentWillMount() {
            ...
            loadjs('public/js/common.js', function() {
            loadjs('public/js/imagesloaded.min.js', function() {
            loadjs('public/js/jquery-ui.js');
            loadjs('public/js/masonry.pkgd.min.js');
            loadjs('public/js/scripts.js');
           });
        ...
        return (
            <div>
                <div className="main-slider-wrap">
                    <div className="main-slider" data-slick="{
				 	&quot;arrows&quot;: false,
				 	&quot;fade&quot;: true,
				 	&quot;speed&quot;: 500
				 }">
                        <div className="tt-slide">
                            <div className="slide-bg" data-src={'img/main-slider-1.jpg'}>
                                <img src={logo} alt="bg" />
                            </div>
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 text-center">
                                        <p className="tt-slide_description">Los mejores karaokes. Expresa tu voz.</p>
                                        <p className="tt-slide_header"><span className="font-gradient">Play Voice</span><br />reto</p>
                                        {/* <a href="registrate.html" className="button">Registrate</a> */}
                                        <Link className="button" to="/registrar">Registrate</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="tt-slide">
                            <div className="slide-bg" data-src="img/main-slider-2.jpg">
                                <img src="img/main-slider-2.jpg" alt="bg" />
                            </div>
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 text-center">
                                        <p className="tt-slide_description">Bring music to life</p>
                                        <p className="tt-slide_header"><span className="font-gradient">NO STUDIO YET?</span><br />No Problem.</p>
                ...
                <main className="pt-xs-25 pt-md-25 pt-lg-60">
                    {/* Begin text-section */}
                    <section className="white-section parralax-section pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60">
                        <div className="container">
                            <div className="section-header">
                                <h2>Nuestros Planes</h2>
                                <p>Tenemos lso mejores planes para que puedas expresar tu voz al maximo con tu compañeros</p>
                            </div>
                        ...
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" className="parallax-img animate v-top tt-paroller lazy" data-src="img/paralax-5.png" data-paroller-factor="0.18" data-paroller-type="foreground" alt="bg" />
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" className="parallax-img parallax-right v-center anim-delay animate tt-paroller lazy" data-src="img/paralax-4.png" data-paroller-factor="0.12" data-paroller-type="foreground" alt="bg" />
                    </section>
                    {/* End text-section */}
                    {/* Begin testimonials */}
                    <section className="dark-section testimonial-section v-separator pt-xs-40 pt-md-50 pt-lg-100 pb-xs-40 pb-md-50 pb-lg-100">
                        <img src="img/quote.png" className="quote-img" alt="img" />
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-12 col-sm-6">
                                    <div className="testimonials-slider white-arrow" data-slick="{
								 	&quot;slidesToShow&quot;: 1,
								 	&quot;swipeToSlide&quot;: true,
								 	&quot;adaptiveHeight&quot;: true,
								 	&quot;responsive&quot;: [
                                        ...
                                        <div className="tt-slide">
                                            <div className="text-block white">
                                                <h2>One Say</h2>
                                                <p>Esta cancion me encanta y en key Karaoke pude cantar con mis amigos.</p>
                                                <h5 className="theme-color mb-0">– Lucia A. Milano</h5>
                                            </div>
                                        </div>
                                        <div className="tt-slide">
                                            <div className="text-block white">
                                                <h2>Love History</h2>
                                                <p>Esta cancion me encanta y en key Karaoke pude cantar con mis amigos.</p>
                                                <h5 className="theme-color mb-0">– Julio R. Cuadros</h5>
                                            </div>
                                        </div>
                                        <div className="tt-slide">
                                            <div className="text-block white">
                                                <h2>Guantamanera</h2>
                                                <p>Esta cancion me encanta y en key Karaoke pude cantar con mis amigos.</p>
                                                <h5 className="theme-color mb-0">– Jualia Casafranca</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-sm-6">
                                    <svg width={506} height={506} className="testimonial-svg" viewBox="0 0 506 506" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                        ...
                                        <g mask="url(#mask0)">
                                            <rect opacity="0.9" width={904} height={591} transform="matrix(-1 0 0 1 654 -43)" fill="url(#pattern0)" />
                                        </g>
                                        <defs>
                                            <pattern id="pattern0" patternContentUnits="objectBoundingBox" width={1} height={1}>
                                                <use xlinkHref="#testimonials-1" transform="translate(0 -0.0101108) scale(0.000471698 0.000721515)" />
                                            </pattern>
                                            ...
                                            <image id="testimonials-1" width={2120} height={1414} xlinkHref={testimonial} />
                                        </defs>
                                    </svg>
                                </div>
                            </div>
				...
				"nextArrow": "$(&apos;#testimonial-next&apos;)", */}
                    ...
                    {/* Begin news section */}
                    <section className="white-section parralax-section pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60">
                        <div className="container pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60">
                            <div className="row">
                                <div className="col-12">
                                    <div className="section-header">
                                        <h2>Ultimos Eventos</h2>
                                        <p>Nuestros ultimos conciertos y presentaciones donde muchos ya expresaron con su voz en Heykaraoke para todo el mundo</p>
                                    </div>
                                    <div className="news-slider arrow-outside" data-slick="{
								 	&quot;slidesToShow&quot;: 3,
								 	&quot;swipeToSlide&quot;: true,
								 	&quot;adaptiveHeight&quot;: true,
								 	&quot;responsive&quot;: [
                                            ...
                                            <div className="news-card">
                                                ...
                                                <div className="news-card_description">
                                                    <time dateTime="2019-10-12">
                                                        <svg width={15} height={16} viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 0.937988C6.46484 0.937988 5.49316 1.13818 4.58496 1.53857C3.67676 1.9292 2.88086 2.46631 2.19727 3.1499C1.52344 3.82373 0.986328 4.61475 0.585938 5.52295C0.195313 6.43115 0 7.40283 0 8.43799C0 9.47314 0.195313 10.4448 0.585938 11.353C0.986328 12.2612 1.52344 13.0571 2.19727 13.7407C2.88086 14.4146 3.67676 14.9468 4.58496 15.3374C5.49316 15.7378 6.46484 15.938 7.5 15.938C8.53516 15.938 9.50684 15.7378 10.415 15.3374C11.3232 14.9468 12.1143 14.4146 12.7881 13.7407C13.4717 13.0571 14.0088 12.2612 14.3994 11.353C14.7998 10.4448 15 9.47314 15 8.43799C15 7.40283 14.7998 6.43115 14.3994 5.52295C14.0088 4.61475 13.4717 3.82373 12.7881 3.1499C12.1143 2.46631 11.3232 1.9292 10.415 1.53857C9.50684 1.13818 8.53516 0.937988 7.5 0.937988ZM7.5 14.4438C6.67969 14.4438 5.90332 14.2876 5.1709 13.9751C4.43848 13.6528 3.79883 13.2231 3.25195 12.686C2.71484 12.1392 2.28516 11.4995 1.96289 10.7671C1.65039 10.0347 1.49414 9.2583 1.49414 8.43799C1.49414 7.61768 1.65039 6.84131 1.96289 6.10889C2.28516 5.37646 2.71484 4.7417 3.25195 4.20459C3.79883 3.65771 4.43848 3.22803 5.1709 2.91553C5.90332 2.59326 6.67969 2.43213 7.5 2.43213C8.32031 2.43213 9.09668 2.59326 9.8291 2.91553C10.5615 3.22803 11.1963 3.65771 11.7334 4.20459C12.2803 4.7417 12.71 5.37646 13.0225 6.10889C13.3447 6.84131 13.5059 7.61768 13.5059 8.43799C13.5059 9.2583 13.3447 10.0347 13.0225 10.7671C12.71 11.4995 12.2803 12.1392 11.7334 12.686C11.1963 13.2231 10.5615 13.6528 9.8291 13.9751C9.09668 14.2876 8.32031 14.4438 7.5 14.4438ZM7.88086 4.68799H6.75293V9.18506L10.6494 11.5874L11.25 10.606L7.88086 8.58447V4.68799Z" /></svg>12.10.2019
                  </time>
                                                    <a href="#" className="news-cart_name">Ponte a cantar en ultimo concierto para rockstar</a>
                                                    <p>El eventos mas esperado de la final de Rockstar para el mundo...</p>
                                                    <a href="#" className="read-more">
                                                        <svg width={9} height={10} viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z" /></svg>leer más
                  </a>
                                                </div>
                                            ...
                                            <div className="news-card">
                                                ...
                                                <div className="news-card_description">
                                                    <time dateTime="2019-10-14">
                                                        <svg width={15} height={16} viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 0.937988C6.46484 0.937988 5.49316 1.13818 4.58496 1.53857C3.67676 1.9292 2.88086 2.46631 2.19727 3.1499C1.52344 3.82373 0.986328 4.61475 0.585938 5.52295C0.195313 6.43115 0 7.40283 0 8.43799C0 9.47314 0.195313 10.4448 0.585938 11.353C0.986328 12.2612 1.52344 13.0571 2.19727 13.7407C2.88086 14.4146 3.67676 14.9468 4.58496 15.3374C5.49316 15.7378 6.46484 15.938 7.5 15.938C8.53516 15.938 9.50684 15.7378 10.415 15.3374C11.3232 14.9468 12.1143 14.4146 12.7881 13.7407C13.4717 13.0571 14.0088 12.2612 14.3994 11.353C14.7998 10.4448 15 9.47314 15 8.43799C15 7.40283 14.7998 6.43115 14.3994 5.52295C14.0088 4.61475 13.4717 3.82373 12.7881 3.1499C12.1143 2.46631 11.3232 1.9292 10.415 1.53857C9.50684 1.13818 8.53516 0.937988 7.5 0.937988ZM7.5 14.4438C6.67969 14.4438 5.90332 14.2876 5.1709 13.9751C4.43848 13.6528 3.79883 13.2231 3.25195 12.686C2.71484 12.1392 2.28516 11.4995 1.96289 10.7671C1.65039 10.0347 1.49414 9.2583 1.49414 8.43799C1.49414 7.61768 1.65039 6.84131 1.96289 6.10889C2.28516 5.37646 2.71484 4.7417 3.25195 4.20459C3.79883 3.65771 4.43848 3.22803 5.1709 2.91553C5.90332 2.59326 6.67969 2.43213 7.5 2.43213C8.32031 2.43213 9.09668 2.59326 9.8291 2.91553C10.5615 3.22803 11.1963 3.65771 11.7334 4.20459C12.2803 4.7417 12.71 5.37646 13.0225 6.10889C13.3447 6.84131 13.5059 7.61768 13.5059 8.43799C13.5059 9.2583 13.3447 10.0347 13.0225 10.7671C12.71 11.4995 12.2803 12.1392 11.7334 12.686C11.1963 13.2231 10.5615 13.6528 9.8291 13.9751C9.09668 14.2876 8.32031 14.4438 7.5 14.4438ZM7.88086 4.68799H6.75293V9.18506L10.6494 11.5874L11.25 10.606L7.88086 8.58447V4.68799Z" /></svg>14.10.2019
                  </time>
                                                    <a href="#" className="news-cart_name">Nuevos calidad de sonidos para clientes privados sin limites</a>
                                                    <p>La mejores combinacion de sonidos creando una banda sonora unica...</p>
                                                    <a href="#" className="read-more">
                                                        <svg width={9} height={10} viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z" /></svg>leer más
                  </a>
                                                </div>
                        ...
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" className="parallax-img animate v-center tt-paroller lazy" data-src="img/paralax-3.png" data-paroller-factor="0.18" data-paroller-type="foreground" alt="bg" />
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" className="parallax-img parallax-right v-bottom anim-delay animate tt-paroller lazy" data-src="img/paralax-4.png" data-paroller-factor="0.12" data-paroller-type="foreground" alt="bg" />
                    </section>
                    {/* End news-section */}
                </main>
                <Footer />
